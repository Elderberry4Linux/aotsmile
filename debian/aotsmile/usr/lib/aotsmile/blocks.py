...
try:
	pointBlock_img = pygame.image.load("/usr/share/aotsmile/sprites/block/point_block.png") 
except:
...
try:
	healthBlock_img = pygame.image.load("/usr/share/aotsmile/sprites/block/health_block.png")
