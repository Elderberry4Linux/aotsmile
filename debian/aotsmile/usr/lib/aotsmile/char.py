...
try:
	smile_img = pygame.image.load ("/usr/share/aotsmile/sprites/smile/smile_main.png")
...
lasers = []
try:
	laser_img = pygame.image.load("/usr/share/aotsmile/sprites/lasers/default_red_laser.png")
